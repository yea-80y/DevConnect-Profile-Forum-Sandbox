...
/**
 * Swarm Feed Uploader - Directory Upload Method
 *
 * This script uses the official bee-js uploadFilesFromDirectory() method
 * as recommended in the Swarm documentation for hosting websites.
 */
...
(async () => {
  console.log('\n🚀 Starting Swarm Directory Upload (using uploadFilesFromDirectory)...\n');
  ...
  try {
    ...
    // Upload directory using the official bee-js method
    console.log(`📤 Uploading directory: ${UPLOAD_DIR}...`);

    const uploadResult = await bee.uploadFilesFromDirectory(
      POSTAGE_BATCH_ID,
      UPLOAD_DIR,
      {
